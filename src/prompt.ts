...
- For read_files tool, convert @ paths to actual paths: "@/components/ui/button" → "components/ui/button.tsx"
- Never use @ in read_files or file system operations
...
2. read_files - Read file contents (use actual paths, not @ aliases)
...
1. Use read_files on app/page.tsx to verify:
...
1. Use read_files with actual path: "components/ui/button.tsx"
...
3. **Implement Features Incrementally**
   ...
   - Use read_files to verify after each major change
...
- [ ] No syntax errors (verified with read_files)
...
5. read_files "app/page.tsx" to verify
...
9. Verify each file with read_files
...
- Use read_files to verify before finishing
